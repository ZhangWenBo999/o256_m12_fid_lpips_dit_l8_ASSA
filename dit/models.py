...
# from module_test.cas import *
# from module_test.hybrid_cas import *
from module_test.ASSA import *
# from module_test.FADC import *
...
class DiT(nn.Module):
    ...
    def __init__(
        ...
        # self.fadc_conv = FADConv(in_channels=hidden_size)
